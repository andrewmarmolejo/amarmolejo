        ...
        <div class='container'>
            <div class='text-center'>
                ...
                <div class="jumbotron">
                    ...
                    <a href="search.php" class="btn btn-primary btn-lg active" role="button" aria-pressed="true">User Search</a><br /><br /><hr width=45%>
                    <form method="POST" action="loginProcess.php">
                        ...
                        <br />
                        <input id="submitButton" type="submit" name="searchForm" value="Admin Log In" class="btn btn-primary btn-lg active">
                    </form>
                </div>
                <?php
