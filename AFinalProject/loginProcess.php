<?php
    ...
    $sql = "SELECT * FROM cast_admin WHERE username = :username AND password = :password";
            ...
            <div class='text-center'>
                ...
                <nav class="navbar navbar-expand-lg navbar-light bg-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav">
                            <li class="nav-item">
                                <a class="nav-link" href="inc/search.php">Search</a>
                            </li>
                ...
                <!--Jumbotron For Login + Wrong Username or Password-->
                <div class="jumbotron">
                    <h1> CSUMB</h1>
